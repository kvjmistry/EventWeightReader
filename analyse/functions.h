...
TH1D *hCV_genie_Sig  = new TH1D("hCV_genie_Sig", "Genie Sig;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_Bkg  = new TH1D("hCV_genie_Bkg", "Background Events;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_Gen  = new TH1D("hCV_genie_Gen", "Generated Events;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_eff  = new TH1D("hCV_genie_eff", "Efficiency;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_xsec = new TH1D("hCV_genie_xsec","Data Cross Section;; Percentage Uncertainty [%]", 35, 0, -1);

TH1D *hCV_genie_Sig_p1sig  = new TH1D("hCV_genie_Sig_p1sig", "Genie Sig;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_Bkg_p1sig  = new TH1D("hCV_genie_Bkg_p1sig", "Background Events;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_Gen_p1sig  = new TH1D("hCV_genie_Gen_p1sig", "Genie Gen;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_eff_p1sig  = new TH1D("hCV_genie_eff_p1sig", "Efficiency;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_xsec_p1sig = new TH1D("hCV_genie_xsec_p1sig","Data Cross Section;; Percentage Uncertainty [%]", 35, 0, -1);

TH1D *hCV_genie_Sig_m1sig  = new TH1D("hCV_genie_Sig_m1sig", "Genie Sig;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_Bkg_m1sig  = new TH1D("hCV_genie_Bkg_m1sig", "Background Events;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_Gen_m1sig  = new TH1D("hCV_genie_Gen_m1sig", "Genie Gen;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_eff_m1sig  = new TH1D("hCV_genie_eff_m1sig", "Efficiency;; Percentage Uncertainty [%]",   35, 0, -1);
TH1D *hCV_genie_xsec_m1sig = new TH1D("hCV_genie_xsec_m1sig","Data Cross Section;; Percentage Uncertainty [%]", 36, 0, -1);
...
void hist_options(TCanvas* c, TH1D* msim, TH1D* p1sig, TH1D* m1sig, double axis_range, int n_uni, const char *print_name ){
	...
	TLegend *legend = new TLegend(0.15, 0.75, 0.3, 0.88);
	...
	TPaveText *pt = new TPaveText(0.62, 0.83, 0.82, 0.90,"NDC");
