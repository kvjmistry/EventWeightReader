...
class Event_List {
	public:
		Event_List()=default;
		Event_List(std::string label_, std::string reweighter_, std::string mode_) {label = label_; reweighter = reweighter_; mode = mode_;}; // constructor
		std::string reweighter;          // Reweighter type e.g. genie, model, reinteractions
